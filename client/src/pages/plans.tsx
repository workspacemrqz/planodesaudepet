...
import { splitFeaturesIntoColumns } from "@/lib/feature-sorting";
  ...
  return (
    <main>
      ...
      <section className="pt-32 pb-20 text-[#fbf9f7] bg-[#277677]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 pl-[20px] pr-[20px]">
          ...
          <AnimatedList animation="slideUp" delay={400} staggerDelay={100}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-16 sm:mb-20 max-w-6xl mx-auto px-4 sm:px-0 pl-[0px] pr-[0px]">
              {currentPlans.map((plan, index) => (
                <Card key={plan.id || index} className={`relative transition-all duration-300 hover:shadow-2xl flex flex-col h-auto sm:h-[600px] md:h-[650px] w-full bg-[#FBF9F7] border-[#277677]/30 ${plan.name === 'INFINITY' || plan.name === 'COMFORT' || plan.name === 'PLATINUM' ? 'plan-card-with-bottom-icon' : ''}`}>
                  ...
                  <CardContent className="px-6 sm:px-4 pb-2 sm:pb-3 flex flex-col flex-grow">
                    <ul className="mb-6 sm:mb-4 text-center">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 mx-auto max-w-md">
                        <div className="space-y-2">
                          {(() => {
                            const { leftColumn } = splitFeaturesIntoColumns(plan.features);
                            return leftColumn.map((feature: string, featureIndex: number) => (
                              <li key={featureIndex} className="flex items-start space-x-1 text-left">
                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#277677" className="h-4 w-4 flex-shrink-0 mt-0.5">
                                  <path d="M180-475q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm180-160q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm240 0q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm180 160q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29ZM266-75q-45 0-75.5-34.5T160-191q0-52 35.5-91t70.5-77q29-31 50-67.5t50-68.5q22-26 51-43t63-17q34 0 63 16t51 42q28 32 49.5 69t50.5 69q35 38 70.5 77t35.5 91q0 47-30.5 81.5T694-75q-54 0-107-9t-107-9q-54 0-107 9t-107 9Z"/>
                                </svg>
                                <span className="text-sm font-normal text-[#302e2b] leading-tight text-left">{feature}</span>
                              </li>
                            ));
                          })()}
                        </div>
                        <div className="space-y-2">
                          {(() => {
                            const { rightColumn } = splitFeaturesIntoColumns(plan.features);
                            return rightColumn.map((feature: string, featureIndex: number) => (
                              <li key={featureIndex} className="flex items-start space-x-1 text-left">
                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#277677" className="h-4 w-4 flex-shrink-0 mt-0.5">
                                  <path d="M180-475q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm180-160q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm240 0q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm180 160q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29ZM266-75q-45 0-75.5-34.5T160-191q0-52 35.5-91t70.5-77q29-31 50-67.5t50-68.5q22-26 51-43t63-17q34 0 63 16t51 42q28 32 49.5 69t50.5 69q35 38 70.5 77t35.5 91q0 47-30.5 81.5T694-75q-54 0-107-9t-107-9q-54 0-107 9t-107 9Z"/>
                                </svg>
                    ...
                    <div className="flex-shrink-0 mt-auto mb-4" style={{pointerEvents: 'auto'}}>
                      <Button 
                        className="w-full h-10 sm:h-12 text-sm sm:text-base lg:text-lg font-semibold rounded-lg transition-all duration-200 mobile-touch-target text-[#FBF9F7]"
                        style={{
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card className="bg-white border-[#277677]/20 shadow-lg">
                  <CardHeader className="bg-[#277677]/5 border-b border-[#277677]/10">
                    <CardTitle className="text-xl font-bold text-[#277677] flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#E1AC33" className="h-5 w-5 mr-2">
                        <path d="M180-475q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm180-160q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm240 0q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm180 160q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29ZM266-75q-45 0-75.5-34.5T160-191q0-52 35.5-91t70.5-77q29-31 50-67.5t50-68.5q22-26 51-43t63-17q34 0 63 16t51 42q28 32 49.5 69t50.5 69q35 38 70.5 77t35.5 91q0 47-30.5 81.5T694-75q-54 0-107-9t-107-9q-54 0-107 9t-107 9Z"/>
                      </svg>
                      Consultas
                    </CardTitle>
                  ...
                  <CardContent className="p-4">
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#277677" className="h-4 w-4 mt-0.5 mr-2 flex-shrink-0"><path d="M180-475q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm180-160q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm240 0q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm180 160q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29ZM266-75q-45 0-75.5-34.5T160-191q0-52 35.5-91t70.5-77q29-31 50-67.5t50-68.5q22-26 51-43t63-17q34 0 63 16t51 42q28 32 49.5 69t50.5 69q35 38 70.5 77t35.5 91q0 47-30.5 81.5T694-75q-54 0-107-9t-107-9q-54 0-107 9t-107 9Z"/></svg>
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-[#277677] text-white shadow-lg">
                  <CardHeader className="bg-[#165b5b] border border-[#135656] rounded-t-lg">
                  ...
                  <CardContent className="p-6">
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#E1AC33" className="h-4 w-4 mt-0.5 mr-2 flex-shrink-0"><path d="M180-475q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm180-160q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm240 0q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29Zm180 160q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29ZM266-75q-45 0-75.5-34.5T160-191q0-52 35.5-91t70.5-77q29-31 50-67.5t50-68.5q22-26 51-43t63-17q34 0 63 16t51 42q28 32 49.5 69t50.5 69q35 38 70.5 77t35.5 91q0 47-30.5 81.5T694-75q-54 0-107-9t-107-9q-54 0-107 9t-107 9Z"/></svg>
      ...
      <div className={`fixed bottom-6 left-6 right-6 z-50 md:hidden transition-all duration-500 ease-out transform ${
        ...
        <button
          onClick={scrollToTop}
          className="w-full text-white px-3 py-3 rounded-full flex items-center justify-center gap-2"
          style={{
            background: 'linear-gradient(to top, #1c6363, #277677)'
          }}
        >
