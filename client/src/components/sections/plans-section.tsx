            ...
            <Card key={plan.id || index} className="relative transition-all duration-300 hover:shadow-2xl flex flex-col h-[480px] sm:h-[560px] w-full bg-[#FBF9F7] border-[#277677]/30">
              ...
              <CardHeader className="text-center pb-4 sm:pb-6 p-4 sm:p-6 flex-shrink-0">
                <div className="flex flex-col items-center gap-2 mb-2">
                  {plan.name === 'BASIC' && (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125" className="w-12 h-12" fill="#277677">
              ...
              <CardContent className="px-4 sm:px-6 pb-6 sm:pb-8 flex flex-col flex-grow">
                ...
                <div className="mt-auto flex-shrink-0 space-y-3">
                  ...
                  <div className="flex justify-end">
                    <button 
                      className="flex items-center gap-1 text-[#E1AC33] text-sm font-medium cursor-pointer hover:text-[#E1AC33] transition-none mobile-touch-target p-1"
                      onClick={() => {
                        const planDetailsSection = document.getElementById(`plan-${plan.name.toLowerCase()}-details`);
                        if (planDetailsSection) {
                          planDetailsSection.scrollIntoView({ behavior: 'smooth', block: 'start' });
                        } else {
                          // Se não encontrar a seção na página atual, redireciona para a página de planos
                          window.location.href = `/plans#plan-${plan.name.toLowerCase()}-details`;
                        }
                      }}
                    >
                      Ver detalhes
                      <ArrowRight className="h-3 w-3 text-[#E1AC33]" />
                    </button>
                  </div>
                </div>
              </CardContent>
