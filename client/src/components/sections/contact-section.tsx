      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pl-[20px] pr-[20px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 px-4 sm:px-0 pl-[0px] pr-[0px]">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            {/* Social Media */}
            <div>
              <h4 className="text-xl font-bold mb-4 text-[#FBF9F7] text-center">Siga-nos</h4>
              <div className="flex justify-center space-x-4">
                <a href="#" className="w-10 h-10 rounded-full flex items-center justify-center bg-[#FBF9F7] text-[#277677] mobile-touch-target">
